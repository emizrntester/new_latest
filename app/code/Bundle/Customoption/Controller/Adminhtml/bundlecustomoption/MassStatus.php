...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('bundlecustomoption');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Bundle\Customoption\Model\Bundlecustomoption')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('customoption/*/index');
    }
