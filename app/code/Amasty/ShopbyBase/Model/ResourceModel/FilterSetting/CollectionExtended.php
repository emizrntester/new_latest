    ...
    private function getDefaultData($filterCode)
    {
        ...
        switch ($filterCode) {
            ...
            case 'am_on_sale':
                ...
                $data[FilterSettingInterface::TOP_POSITION] =
                    $this->filterSettingHelper->getConfig($filterCode, 'top_position');
                $data[FilterSettingInterface::SIDE_POSITION] =
                    $this->filterSettingHelper->getConfig($filterCode, 'side_position');
                break;
        }
