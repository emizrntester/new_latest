    ...
    $.widget('mage.amShopbyAjax', {
        ...
        reloadHtml: function (data) {
            var selectSidebarNavigation = '.sidebar.sidebar-main .block.filter',
                ...
                $productsWrapper = $(this.selectors.products_wrapper);
            ...
            if (mainContent) {
                $productsWrapper.last().replaceWith(mainContent);

                if (typeof $.fn.applyBindings !== 'undefined') {
                    ko.cleanNode($productsWrapper[0])
                    $productsWrapper.applyBindings();
                }

                $productsWrapper.last().trigger('contentUpdated');
            }
