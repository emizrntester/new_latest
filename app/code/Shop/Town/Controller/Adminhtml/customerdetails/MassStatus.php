...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('customerdetails');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Shop\Town\Model\Customerdetails')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('town/*/index');
    }
