...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Emizen_Techdata::manu')
            ->addBreadcrumb(__('Emizen Techdata'), __('Emizen Techdata'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Emizen\Techdata\Model\Test');
        ...
        $this->_coreRegistry->register('techdata', $model);
