...
return [
    'modules' => [
        ...
        'Amasty_ShopbySeo' => 0,
        'Amasty_ShopbyPage' => 0,
        'Amasty_GroupedOptions' => 0,
        'Amazon_Core' => 0,
        'Amazon_Login' => 0,
        'Amazon_Payment' => 0,
        'Bundle_Customoption' => 0,
        'Chapagain_CustomerAttribute' => 0,
        'Cloudways_Mymodule' => 0,
        'Company_Module' => 0,
        'Customapi_ReorderApi' => 0,
        'Dev_Testing' => 0,
        'Dotdigitalgroup_Email' => 0,
        'Dotdigitalgroup_Chat' => 0,
        'Ecomsolver_Customcheck' => 0,
        'Emizen_Codetest' => 0,
        'Emizen_Learn' => 0,
        'Emizen_Mymodule' => 0,
        'Emizen_Techdata' => 0,
        'Emizenn_Data' => 0,
        'Emizentech_Categoryfilterapi' => 1,
        'Emizentech_Scriptconfig' => 0,
        'Experius_CodeBlogAddressAttributeToCheckout' => 1,
        'IWD_Opc' => 0,
        'Inchoo_Helloworld' => 0,
        'Klarna_Core' => 0,
        ...
        'Mageplaza_LazyLoading' => 0,
        'Magezon_Deliverydate' => 0,
        'Mock_Exam' => 0,
        'Myvendor_Mymodule' => 0,
        'PayPal_Braintree' => 0,
        'PayPal_BraintreeGraphQl' => 0,
        'Pulsestorm_JavascriptInitTutorial' => 0,
        'Pulsestorm_Logdropdown' => 1,
        'Pulsestorm_RequireJsRewrite' => 0,
        'Pulsestorm_RequireJsTutorial' => 0,
        'Pulsestorm_TutorialProxy1' => 0,
        'Pulsestorm_TutorialProxy2' => 0,
        'RH_UiExample' => 0,
        'Reorder_ReorderApi' => 0,
        'Rsgitech_Customer' => 0,
        'Shop_Town' => 0,
        'SilkSoftware_ModuleName' => 0,
        'Spider_Tech' => 0,
        'Tech_Newtech' => 0,
